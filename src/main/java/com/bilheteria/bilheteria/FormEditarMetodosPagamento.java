 ...
 * @author raul_
 */
public class FormEditarMetodosPagamento extends javax.swing.JFrame {

    private int id;

    public FormEditarMetodosPagamento(int id, String nome) {
        this.id = id;
        initComponents();
    ...
    /**
     * Creates new form FormEditarMetodosPagamento
     */
    public FormEditarMetodosPagamento() {
        initComponents();
    }
    ...
    private void textNomeOnclickNome(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textNomeOnclickNome
        // TODO add your handling code here:
    }//GEN-LAST:event_textNomeOnclickNome
    ...
    private void OnclickSalvar(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OnclickSalvar
        ...
        if (nome.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "O nome não podem estar vazios.");
            return;
        }

        // Verificando se o nome contém apenas letras e tem no máximo 24 caracteres
        if (!nome.matches("[A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑ ]+") || nome.length() > 24) {
            // Exibir mensagem de erro e não salvar
            JOptionPane.showMessageDialog(this, "O nome deve ter apenas letras e no máximo 24 caracteres.");
            return;
        }

        // Criar uma instância de Metodo de Pagamento e chamar o método PUT
        MetodoPagamento MetodoPagamento = new MetodoPagamento();
        String response = MetodoPagamento.editarMetodoPUT(id, nome);

        // Processar a resposta da API
        // Aqui você pode atualizar a UI ou realizar outras ações com base na resposta
        System.out.println("Resposta recebida no FormEditarMetodosPagamentos: " + response);

        // Verificar e exibir mensagem baseada na resposta da API
        if (response != null) {
            if (response.equals("sucesso")) {
                // Exibir mensagem de sucesso
                JOptionPane.showMessageDialog(this, "MetodoPagamento atualizado com sucesso!");
            ...
            JOptionPane.showMessageDialog(this, "Erro ao atualizar o MetodoPagamento. Tente novamente.");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormEditarMetodosPagamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormEditarMetodosPagamento().setVisible(true);
            }
        });
    }
